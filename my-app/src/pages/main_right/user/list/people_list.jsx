...
function List() {
  ...
  useEffect(() => {
    axios.get('/pessoas')
        .then(response => {
            setPeople(response.data.filter(people => people.ativo === 1));
        })
        .catch(error => {
  ...
  return (
    <div className="body">
      ...
      <div className='people'>
        ...
        {/* CRIAÇÃO DA TABELA DA LISTA DE PESSOAS */}

        <table>
                  <thead>
                      <tr><td className='people-list-title' colspan="5">Lista de Pessoas</td></tr>
